...
class MetaborgConfigPlugin : Plugin<Project> {
  override fun apply(project: Project) {
    project.configureGroup()
    project.configureVersion() // Only root project needs to configure version, as gitonium will set versions for subprojects automatically.
    project.configurePublishingRepositories()
    project.tasks {
    ...
    project.extensions.add("metaborg-config", MetaborgConfigExtension(project))
  }
